...
# 立即修正
gh issue reopen <NUM>
gh issue comment <NUM> --body "⚠️ 此 Issue 尚未經案主測試確認，已重新開啟。"
```

### 為什麼這條規則絕對不能違反？

1. **案主是最終驗收者** - 只有案主知道修復是否符合期望
2. **AI 判斷有局限性** - 代碼正確不代表業務需求滿足
3. **專業工作流程** - 讓案主感受到嚴謹的品質控管
4. **避免信任損失** - 過早關閉會讓案主困惑和不信任
