...
export const Button: React.FC<ButtonProps> = ({
  ...
  const variants: Record<ButtonVariant, string> = {
    ...
    ghost: disabled
      ? "bg-white/80 text-gray-700 border border-gray-200 focus:ring-gray-300"
      : "bg-white/80 text-gray-700 border border-gray-200 hover:bg-white focus:ring-gray-300",
    danger: disabled
